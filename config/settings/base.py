...
MIGRATION_MODULES = {"sites": "zs.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "zs.apps.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Muhammad Ilyas Yousuf""", "milyasyousuf@outlook.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "zs.apps.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "zs.apps.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "zs.apps.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "zs.apps.users.forms.UserSocialSignupForm"}
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "zs.apps.core.exception_handler.custom_exception_handler",
...
SPECTACULAR_SETTINGS = {
    "TITLE": "ZS API",
    "DESCRIPTION": "Documentation of API endpoints of ZS",
    "VERSION": "1.0.0",
